...
for nosessions in 1 10 100 1000 10000; do
  ...
  taskset -c 1 $BIN_DIR/pingpong_server 0.0.0.0 55555 $nothreads $bufsize & srvpid=$!
  taskset -c 2 $BIN_DIR/pingpong_client 127.0.0.1 55555 $nothreads $bufsize $nosessions $timeout
  kill -9 $srvpid
done